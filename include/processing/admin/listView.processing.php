...
// This file contains all of the includes needed for processing the smallTable
...
include_once(PROCESSING_ADMIN."listView.array.wrappers.php"); // fitting listview into small table
