...
function userPasswordModal($user_info){
  ...
  $modal = '<div class="modal-header user-modal">
        ...
        <h4 class="modal-title" id="userModalLabel">Change Password For: '. $username . ' (ID: <span id="userID">'. $id .'</span>)</h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="submit-editModal" disabled>Update</button>
      </div>
          ';
